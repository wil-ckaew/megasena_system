...
# Matar Python se estiver rodando
pkill -f "python.*5000" 2>/dev/null

echo ""
echo "1. 🐍 Iniciando Python ML Service..."
cd ml_service
...
sleep 8
echo "   🧪 Testando Python ML..."
if curl -s http://localhost:5000/health > /dev/null; then
    echo "   ✅ Python ML OK"
    curl -s http://localhost:5000/ | grep -o '"data_points":[0-9]*'
else
    echo "   ❌ Python ML falhou"
    exit 1
fi

echo ""
echo "2. 🦀 Iniciando Backend Rust (Proxy)..."
cd backend_rust
...
echo ""
echo "3. ⚛️ Criando Frontend que mostra IA Python..."
cd frontend_nextjs

cat > pages/index.js << 'FRONTEOF'
...
echo ""
echo "========================================"
echo "🎉 SISTEMA COM IA PYTHON PRONTO!"
echo "========================================"
echo ""
echo "🌐 Acesse: http://localhost:3000"
echo ""
echo "📊 FLUXO CORRETO:"
echo "1. Frontend → Rust Proxy (8080)"
echo "2. Rust Proxy → Python ML (5000)"
echo "3. Python ML analisa CSV com 52 sorteios"
echo "4. IA gera números baseado em estatísticas reais"
echo "5. Resultado volta para frontend"
echo ""
echo "🤖 TESTE MANUAL DA IA:"
